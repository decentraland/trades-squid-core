...
export const events = {
  ContractSignatureIndexIncreased: event(
    '0x09cc1ddfeaa3955efcd7527dadf166c8dd69e1e1ac87e52919eb59da0b42ee19',
    'ContractSignatureIndexIncreased(address,uint256)',
    { _caller: indexed(p.address), _newValue: indexed(p.uint256) }
  ),
  CouponManagerUpdated: event(
    '0x143fb5dd4c4edb29ec8dd5b4bd1d0c1fbdeec8869d2a3548e922affb61470f82',
    'CouponManagerUpdated(address,address)',
    { _caller: indexed(p.address), _couponManager: indexed(p.address) }
  ),
  FeeCollectorUpdated: event(
    '0x5d16ad41baeb009cd23eb8f6c7cde5c2e0cd5acf4a33926ab488875c37c37f38',
    'FeeCollectorUpdated(address,address)',
    { _caller: indexed(p.address), _feeCollector: indexed(p.address) }
  ),
  FeeRateUpdated: event(
    '0x98259702e6263eb2c9423b892e36fcaaaac8885fbeab7826218791df24d84987',
    'FeeRateUpdated(address,uint256)',
    { _caller: indexed(p.address), _feeRate: p.uint256 }
  ),
  MetaTransactionExecuted: event(
    '0x5845892132946850460bff5a0083f71031bc5bf9aadcd40f1de79423eac9b10b',
    'MetaTransactionExecuted(address,address,bytes)',
    {
      _userAddress: indexed(p.address),
      _relayerAddress: indexed(p.address),
      _functionData: p.bytes
    }
  ),
  ...
  Paused: event('0x62e78cea01bee320cd4e420270b5ea74000d11b0c9f74754ebdbfc544b05a258', 'Paused(address)', {
    account: p.address
  }),
  RoyaltiesManagerUpdated: event(
    '0x77d1457fe352712d480bd254327263c64ce777ddfc62c1a0eda5bf2bd843ca2f',
    'RoyaltiesManagerUpdated(address,address)',
    { _caller: indexed(p.address), _royaltiesManager: indexed(p.address) }
  ),
  RoyaltiesRateUpdated: event(
    '0xba55b878cbf32ed69c9c62c58b9c5ec31d1271d9510d2b08a1f9091236d8eacf',
    'RoyaltiesRateUpdated(address,uint256)',
    { _caller: indexed(p.address), _royaltiesRate: p.uint256 }
  ),
  SignatureCancelled: event(
    '0x8c4e82d0c2e3a462d0450cd1797aef55b85987a833dd3d93b61d96824a01410e',
    'SignatureCancelled(address,bytes32)',
    { _caller: indexed(p.address), _signature: indexed(p.bytes32) }
  ),
  SignerSignatureIndexIncreased: event(
    '0x492ddec6f62ab9180c9800a9a60ec15bb0dbae20d2a19cdc824448872f796667',
    'SignerSignatureIndexIncreased(address,uint256)',
    { _caller: indexed(p.address), _newValue: indexed(p.uint256) }
  ),
  Traded: event('0x23f604bb2ed4bd9af0d2e81b9dcadde6b729b6305aa258778502bf640619e8b4', 'Traded(address,bytes32)', {
    _caller: indexed(p.address),
    _signature: indexed(p.bytes32)
  }),
  Unpaused: event('0x5db9ee0a495bf2e6ff9c91a7834c1ba4fdd244a5e8aa4e537bd38aeae4b073aa', 'Unpaused(address)', {
    account: p.address
  })
}
...
export const functions = {
  ...
  ASSET_TYPE_ERC20_WITH_FEES: viewFun('0xd0095c5c', 'ASSET_TYPE_ERC20_WITH_FEES()', {}, p.uint256),
  ASSET_TYPE_ERC721: viewFun('0x7bb185bd', 'ASSET_TYPE_ERC721()', {}, p.uint256),
  accept: fun(
    '0xb0aa10c4',
    'accept((address,bytes,(uint256,uint256,uint256,bytes32,uint256,uint256,bytes32,bytes32[],(address,bytes4,uint256,bool)[]),(uint256,address,uint256,address,bytes)[],(uint256,address,uint256,address,bytes)[])[])',
    {
      _trades: p.array(
        p.struct({
          signer: p.address,
          ...
          checks: p.struct({
            ...
            effective: p.uint256,
            salt: p.bytes32,
            contractSignatureIndex: p.uint256,
            signerSignatureIndex: p.uint256,
            allowedRoot: p.bytes32,
            allowedProof: p.array(p.bytes32),
            externalChecks: p.array(
              p.struct({
  ...
  acceptWithCoupon: fun(
    '0x9a2806a0',
    'acceptWithCoupon((address,bytes,(uint256,uint256,uint256,bytes32,uint256,uint256,bytes32,bytes32[],(address,bytes4,uint256,bool)[]),(uint256,address,uint256,address,bytes)[],(uint256,address,uint256,address,bytes)[])[],(bytes,(uint256,uint256,uint256,bytes32,uint256,uint256,bytes32,bytes32[],(address,bytes4,uint256,bool)[]),address,bytes,bytes)[])',
    {
      _trades: p.array(
        p.struct({
          signer: p.address,
  ...
  cancelSignature: fun(
    '0x11cbb975',
    'cancelSignature((address,bytes,(uint256,uint256,uint256,bytes32,uint256,uint256,bytes32,bytes32[],(address,bytes4,uint256,bool)[]),(uint256,address,uint256,address,bytes)[],(uint256,address,uint256,address,bytes)[])[])',
    {
      _trades: p.array(
        p.struct({
          signer: p.address,
  ...
  executeMetaTransaction: fun(
    '0xd8ed1acc',
    'executeMetaTransaction(address,bytes,bytes)',
    { _userAddress: p.address, _functionData: p.bytes, _signature: p.bytes },
    p.bytes
  ),
  ...
  getTradeId: viewFun(
    '0xff709edf',
    'getTradeId((address,bytes,(uint256,uint256,uint256,bytes32,uint256,uint256,bytes32,bytes32[],(address,bytes4,uint256,bool)[]),(uint256,address,uint256,address,bytes)[],(uint256,address,uint256,address,bytes)[]),address)',
    {
      _trade: p.struct({
        signer: p.address,
        signature: p.bytes,
  ...
  updateCouponManager: fun('0x94188e93', 'updateCouponManager(address)', {
    _couponManager: p.address
  }),
  updateFeeCollector: fun('0xd2c35ce8', 'updateFeeCollector(address)', {
    _feeCollector: p.address
  }),
  updateFeeRate: fun('0x7b84fda5', 'updateFeeRate(uint256)', {
    _feeRate: p.uint256
  }),
  updateRoyaltiesManager: fun('0x6187bb4f', 'updateRoyaltiesManager(address)', {
    _royaltiesManager: p.address
  }),
  updateRoyaltiesRate: fun('0x87b33a21', 'updateRoyaltiesRate(uint256)', {
    _royaltiesRate: p.uint256
  }),
...
export class Contract extends ContractBase {
  ...
  ASSET_TYPE_ERC20_WITH_FEES() {
    return this.eth_call(functions.ASSET_TYPE_ERC20_WITH_FEES, {})
  }
...
export type ASSET_TYPE_ERC20_WITH_FEESParams = FunctionArguments<typeof functions.ASSET_TYPE_ERC20_WITH_FEES>
export type ASSET_TYPE_ERC20_WITH_FEESReturn = FunctionReturn<typeof functions.ASSET_TYPE_ERC20_WITH_FEES>
